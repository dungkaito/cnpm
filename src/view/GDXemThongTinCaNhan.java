 ...
 * @author Dinh Dung
 */
public class GDXemThongTinCaNhan extends javax.swing.JFrame {
    
    private TaiKhoan user;

    /**
     * Creates new form GDXemThongTinCaNhan
     */
    public GDXemThongTinCaNhan(TaiKhoan user) {
        initComponents();
        this.user = user;
    ...
    private void initComponents() {
        ...
        btnCapNhatThongTin.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(27, 27, 27)
                .addComponent(btnCapNhatThongTin, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCapNhatThongTinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhatThongTinActionPerformed
        ...
        this.dispose();
        GDCapNhatThongTinCaNhan f = new GDCapNhatThongTinCaNhan(user);
        f.setVisible(true);
...
//            java.util.logging.Logger.getLogger(GDXemThongTinCaNhan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new GDXemThongTinCaNhan().setVisible(true);
//            }
//        });
//    }
